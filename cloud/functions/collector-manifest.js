// cloud/functions/collector-manifest.js
 ...
 */
function buildRouteManifest(app) {
  const seen = new Map();
...
function formatManifestRoutes(entries) {
 ...
 */
function compareManifest({ workerVersion, workerCalls, manifest }) {
  try {
...
module.exports = { COLLECTOR_API_VERSION, buildRouteManifest, formatManifestRoutes, compareManifest };
