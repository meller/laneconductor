...
**Summary**: 156 of 811 tracks rows have project_id IS NULL. Root cause found: POST /track (ui/server/index.mjs:2677) resolves projectId to null when no token or project_id is given, and ON CONFLICT (project_id,…
**Merge Mode**: direct
**Auto Run**: yes
