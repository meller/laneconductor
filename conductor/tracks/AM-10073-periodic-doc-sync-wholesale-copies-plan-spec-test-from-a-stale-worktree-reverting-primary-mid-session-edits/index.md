...
**Summary**: Replaced the blind copyFileSync in copyWorktreeArtifactsToPrimary with a real three-way merge (git merge-file) against a per-track merge-base cache for plan.md/spec.md/test.md/quality-gate.md.…
