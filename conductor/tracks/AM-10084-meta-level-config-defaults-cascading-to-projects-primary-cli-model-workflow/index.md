...
**Summary**: Setup gaps flagged livingwork's primary CLI as unconfigured/unreachable even though .laneconductor.json and the DB both correctly have primary.cli='claude' (verified) — root cause: livingwork has…
