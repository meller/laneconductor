# Track AM-10084: POST /track field-parity gap on the cloud collector
...
**Summary**: The cloud collector's POST /track insert column list omits `waiting_for_reply`, `auto_run`, `merge_mode`, `workspace_mode`, `log_content`, `model_override`, and every KPI column the local collector persists — a wider version of the same collector-parity gap fixed for `lane_action_status` in track AM-10083.
