...
- [x] Phase 8: Direct Worker Interactive Chat — add interactive chat bar to WorkerActivityLatch to dispatch ad-hoc worker chat turns or track chat prompts directly from the worker activity panel
